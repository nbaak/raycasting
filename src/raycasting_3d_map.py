...
def main():
    ...
    surface_map = pygame.surface.SurfaceType((width, height))  # 2d view
    ...
    while running:
        ...
        pygame.draw.rect(surface, "blue", (0, 0, width, height // 2))
        pygame.draw.rect(surface, "brown", (0, height // 2, width, height // 2))
        
        # Draw Walls
        draw_walls(surface_map, walls, "white", width=10)
        
        # Raycasting
        ray_casting(surface_map, surface, field_of_view, view_direction, walls, window_size, beam_width=2)
        
        # Put screen together
        surface_map = pygame.transform.scale(surface_map, (200,200))
